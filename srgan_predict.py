...
from models.srgan.data_processing import normalize_input_lr, denormalize_output, postprocess_output
...
def main():
    ...
    generator = SrganNetwork().build(num_filters=64, num_residual_blocks=16, trainable=False)
